                        ...
                        <div class="col-lg-11 col-md-11">
                            <div class="contact-box" style="margin-left:180px;">
                                ...
                                <div class="col-lg-10 col-md-10">
                                    ...
                                    <form style="background-color: white;padding:55px 26px 55px 26px;box-shadow: 7px 5px 30px rgb(234 58 8 / 20%);border-radius: 5px;" action="<?= getController('site/registeruser.php') ?>" method="POST">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6">

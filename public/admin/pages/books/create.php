      ...
      <div class="col-md-12">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">إنشاء books</h3>
          </div>
          <div>
          ...
          <div class="card-body">
            <!-- /.card-header -->
            <!-- form start -->
            <form id="quickForm" action="<?= getCntrollor("admin/books/create.php"); ?>" method="post">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="people_number" name="people_number" class="form-control" id="people_number">

...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $OldData = selectWhere($conn, 'messages', '*', "id = $id")[0];
}
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="quickForm" action="<?= getCntrollor("admin/message/update.php"); ?>" method="post">
                            <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" id="name" value="<?= $OldData['first_name'] ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="lastname" class="form-control" id="lastname" value="<?= $OldData['last_name'] ?>">
                                        <?php if (isset($_SESSION['errors']['name'])) : ?>
                                            <p class=" text-danger"><?= $_SESSION['errors']['lastname'] ?></p>
                                        <?php endif ?>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="phone" name="phone" class="form-control" id="phone" value="<?= $OldData['phone'] ?>">

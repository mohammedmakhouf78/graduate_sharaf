...
if (isset($_POST['address'])) {
    ...
    $phone = $_POST['phone'];
    validatePhon($phone, "phone", "error in phone ", getpage("about/create.php"));

    $open = $_POST['open'];
    validateTime($open, "open", "error in open ", getpage("about/create.php"));

    $close = $_POST['close'];
    validateTime($close, "close", "error in close ", getpage("about/create.php"));
